(module
 ...
 (func $node_modules/@as-pect/assembly/assembly/internal/Reflect/Reflect.equals<assembly/__tests__/example.spec/Vec3> (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32) (result i32)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
  (local $7 i32)
  ...
  block $__inlined_func$node_modules/@as-pect/assembly/assembly/internal/Reflect/referencesEqual<assembly/__tests__/example.spec/Vec3> (result i32)
   ...
   block $__inlined_func$assembly/__tests__/example.spec/Vec3#__aspectStrictEquals (result i32)
    ...
    if (result i32)
     ...
     block $__inlined_func$node_modules/@as-pect/assembly/assembly/internal/Reflect/Reflect.equals<f64>3 (result i32)
      i32.const 1
      local.get $5
      f64.load offset=16
      local.tee $11
      ...
      local.tee $13
      f64.eq
      br_if $__inlined_func$node_modules/@as-pect/assembly/assembly/internal/Reflect/Reflect.equals<f64>3
      drop
      i32.const 1
      local.get $11
      local.get $11
 ...
 (func $start:assembly/__tests__/example.spec~anonymous|0~anonymous|5
  ...
  block $folding-inner0
   ...
   if
    local.get $0
    call $byn-split-outlined-A$node_modules/@as-pect/assembly/assembly/internal/log/log<~lib/arraybuffer/ArrayBuffer>
   end
   global.get $~lib/memory/__stack_pointer
   i32.const 4
   i32.add
 ...
 (func $node_modules/@as-pect/assembly/assembly/internal/Reflect/Reflect.toReflectedValue<assembly/__tests__/example.spec/Vec3>@varargs (param $0 i32) (result i32)
  ...
  block $folding-inner1
   ...
   i64.const 0
   i64.store
   block $__inlined_func$node_modules/@as-pect/assembly/assembly/internal/Reflect/Reflect.toReflectedValue<assembly/__tests__/example.spec/Vec3>
    local.get $0
    i32.eqz
    if
     global.get $~lib/memory/__stack_pointer
     ...
     call $node_modules/@as-pect/assembly/assembly/internal/Reflect/createReflectedValue
     local.set $0
     br $__inlined_func$node_modules/@as-pect/assembly/assembly/internal/Reflect/Reflect.toReflectedValue<assembly/__tests__/example.spec/Vec3>
    end
    local.get $1
    i32.load
    local.get $1
 ...
 (func $byn-split-outlined-A$node_modules/@as-pect/assembly/assembly/internal/log/log<~lib/arraybuffer/ArrayBuffer> (param $0 i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
