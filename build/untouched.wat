(module
 ...
 (data (i32.const 620) "\\\00\00\00\00\00\00\00\00\00\00\00\01\00\00\00H\00\00\00I\00n\00i\00t\00i\00a\00l\00i\00s\00i\00n\00g\00 \00c\00h\00u\00n\00k\00e\00d\00f\00l\00e\00x\00l\00i\00s\00t\00 \00l\00i\00b\00r\00a\00r\00y\00\00\00\00\00")
 ...
 (data (i32.const 896) "\t\00\00\00 \00\00\00\00\00\00\00 \00\00\00\00\00\00\00\00\00\00\00\00\00\00\00d\00\00\00\00\00\00\00 \00\00\00\00\00\00\00\02A\00\00\00\00\00\00\04A\00\00\00\00\00\00\10\01\82\00\00\00\00\00\10\02\82\00\00\00\00\00")
 (table $0 1 funcref)
 (elem $0 (i32.const 1))
 (export "init" (func $assembly/index/init@varargs))
 ...
 (func $start:assembly/abstractChunk
  i32.const 1
  global.get $assembly/abstractChunk/AbstractChunk.indexBits
  i32.shl
 ...
 (func $~lib/array/Array<assembly/linkIndex/LinkIndex>#set:length (param $0 i32) (param $1 i32)
  local.get $0
  local.get $1
  i32.const 2
  i32.const 0
  ...
  local.get $0
  local.get $1
  call $~lib/array/Array<assembly/linkIndex/LinkIndex>#set:length_
 )
 (func $assembly/linkIndex/LinkIndex#set:nodeIndex (param $0 i32) (param $1 i32)
  local.get $0
  local.get $1
  i32.store8
 )
 (func $assembly/linkIndex/LinkIndex#set:degree (param $0 i32) (param $1 i32)
  local.get $0
  local.get $1
  i32.store8 offset=1
 )
 ...
 (func $~lib/staticarray/StaticArray<~lib/array/Array<assembly/linkIndex/LinkIndex>>#get:length (param $0 i32) (result i32)
  local.get $0
  i32.const 20
  i32.sub
  i32.load offset=16
 ...
 (func $assembly/index/init@varargs (param $0 i32)
  block $1of1
   block $0of1
    block $outOfRange
 ...
 (func $~lib/array/Array<assembly/linkIndex/LinkIndex>#__visit (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $~lib/array/Array<assembly/linkIndex/LinkIndex>~visit (param $0 i32) (param $1 i32)
  local.get $0
  local.get $1
  call $~lib/array/Array<assembly/linkIndex/LinkIndex>#__visit
 )
 (func $~lib/staticarray/StaticArray<~lib/array/Array<assembly/linkIndex/LinkIndex>>#__visit (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $~lib/staticarray/StaticArray<~lib/array/Array<assembly/linkIndex/LinkIndex>>~visit (param $0 i32) (param $1 i32)
  local.get $0
  local.get $1
     ...
     loop $for-loop|2
      ...
      if
       ...
       if
        ...
        i32.const 255
        i32.and
        call $~lib/array/Array<assembly/linkIndex/LinkIndex>#set:length
        local.get $4
        br $assembly/abstractChunk/AbstractChunk.calculateLinkIndexesAbove|inlined.0
       end
       local.get $5
 ...
 (func $~lib/staticarray/StaticArray<~lib/array/Array<assembly/linkIndex/LinkIndex>>#constructor (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  global.get $~lib/memory/__stack_pointer
 ...
 (func $~lib/array/Array<assembly/linkIndex/LinkIndex>#constructor (param $0 i32) (param $1 i32) (result i32)
  ...
  local.get $0
  i32.const 0
  call $~lib/array/Array<assembly/linkIndex/LinkIndex>#set:buffer
  local.get $0
  i32.const 0
  call $~lib/array/Array<assembly/linkIndex/LinkIndex>#set:dataStart
  local.get $0
  i32.const 0
  call $~lib/array/Array<assembly/linkIndex/LinkIndex>#set:byteLength
  local.get $0
  i32.const 0
  call $~lib/array/Array<assembly/linkIndex/LinkIndex>#set:length_
  local.get $1
 ...
 (func $assembly/linkIndex/LinkIndex#constructor (param $0 i32) (param $1 i32) (param $2 i32) (result i32)
  (local $3 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
  ...
  local.get $0
  i32.const 0
  call $assembly/linkIndex/LinkIndex#set:nodeIndex
  local.get $0
  i32.const 0
  call $assembly/linkIndex/LinkIndex#set:degree
  local.get $0
  local.get $1
  call $assembly/linkIndex/LinkIndex#set:nodeIndex
  local.get $0
 ...
 ;; custom section "as-bind_bindings", size 110, contents: "{\"typeIds\":{},\"importedFunctions\":{},\"exportedFunctions\":{\"init\":{\"returnType\":\"void\",\"parameters\":[\"bool\"]}}}"
)
